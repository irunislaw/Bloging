...
<div
    class="bg-gradient-to-tr py-10 from-rose-500 flex flex-col gap-10 to-orange-500 m-6 w-5/6 rounded-lg shadow-lg duration-200 sm:bg-gradient-to-br lg:from-black lg:to-white lg:w-1/2 xl:w-1/3">
    <div>
